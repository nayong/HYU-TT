...
//        let periods = getTime(time: temp.time)
        ...
        //get data
        let subject1 = CurriculaTableItem(name: temp.nameOfLecture, place: temp.place,weekday: .wednesday, startPeriod: 5, endPeriod: 11, textColor: UIColor.white, bgColor: UIColor(red: 0.78, green: 0.49, blue: 0.87, alpha: 1.0), identifier: "20393", tapHandler: handler)
